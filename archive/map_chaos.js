$(document).ready(function () {
  ...
  require([
    ...
    //         console.log(layerViewResult.layer.title)
    //         if(layerViewResult.layer.title == "Linear Projects" || layerViewResult.layer.title == "Point Projects") {
    //
    ...
    $("#townSelect").change(function () {
      ...
      // var promiseClearFilters = new Promise((resolve) => {
      ...
      // promiseClearFilters.done(clearLayerViews);
      //
      ...
      if ($("#townSelect").val() > 0) {
        $('#loading').modal('show')
        hideLoad = false;
        // var query = townQuery.clone();
        var query;
        query = townLayer.createQuery();
        console.log(query);
        query.where = "TOWN_ID = " + $("#townSelect").val();
        console.log("town changed to: ", query.where);
        ...
        townLayer.queryFeatures(query)
          .then(function (response) {
            ...
            // applyFeatureViewFilters(); //don't need this!!!!! already have sql
    ...
    function applyFeatureViewFilters() {
      ...
      if (spatialFilter === true && projectSearchID == false) {
        ...
        //   }
        // })
        // document.getElementById("numItems").innerHTML = projCount;
    ...
    //
    //   // var dict_FLV = {
    //   //   // projectLocationsPolygons2: prjLocationPolygons,
    //   //   "Linear Projects": prjLocationLines,
    //   //   "Point Projects": prjLocationPoints
    //   //   // projectLocationsMBTA: mbtaLines
    //   // };
    //
    ...
    //
    //   // var layerView = dict_FLV[layer.title];
    ...
    //       );
    //     });
    //     var numProjects = response.features.length;
    //     console.log(layer.title, numProjects);
    //     projCount = projCount + numProjects;
    //     console.log("Total Projects that should be in list: ", projCount);
    //     document.getElementById("numItems").innerHTML = projCount;
    //   });
    // };
    //
    ...
    //             );
    //           });
    //           var numProjects = returnedList.features.length;
